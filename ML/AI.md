###
* [smolGPT](https://github.com/Om-Alve/smolGPT) - minimal PyTorch implementation for training your own small LLM from scratch
...
* [programming with LLMs](https://pmbanugo.me/blog/peer-programming-with-llms)
...
* [Transformer Tricks](https://github.com/OpenMachine-ai/transformer-tricks) to simplify and speed up transformer models
...
* [local RAG](https://blog.yakkomajuri.com/blog/local-rag)
...
+ [SentrySearch](https://github.com/ssrajadh/sentrysearch) - video search
...
+ [AI memory with biological decay](https://github.com/sachitrafa/YourMemory)
...
+ [WEB BROWSING ai](https://github.com/stanford-mast/blast)
+ [V.AI](https://github.com/eotter-beep/vai) - open-source AI characters platform 
...
[Benchmarks are Dead](https://poetiq.ai/posts/benchmarks_are_dead/)
### ACTIONS
...
+ [huggingface skills](https://github.com/huggingface/skills)
 ...
 + [OpenExecutive](https://github.com/SenteLabsAI/OpenExecutive) - an open-source AI executive system combining specialist agents, persistent memory, and proactive task management
